...
$stmt = $pdo->prepare("
    ...
    WHERE p.category = 'سيارات'   
    LIMIT 10  -- لتقليل عدد النتائج
");
$stmt->execute();
$auctions = $stmt->fetchAll(PDO::FETCH_ASSOC);

$stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'سيارات'");
$stmt->execute();
...
<head>
    ...
    <title>مزاد السيارات | منصة المزادات</title>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="منصة المزادات الرائدة لبيع وشراء السيارات بسهولة وأمان. سجل الآن وابدأ المزايدة!">
    <meta property="og:title" content="مزاد السيارات | منصة المزادات">
    <meta property="og:description" content="المنصة الأفضل لمزادات السيارات في الوطن العربي">
...
<header class="main-header">
    <div class="header-container">
        ...
        <div class="search-container">
            <input type="text" class="search-input" placeholder="ابحث عن مزادات السيارات...">
        </div>
    </div>
</header>
...
<section id="auctions" class="section animate-fade" style="animation-delay: 0.2s">
    <h2 class="section-title">مزادات السيارات</h2>
        ...
        <?php foreach ($auctions as $auction): ?>
            <div class="auction-card animate-fade" style="animation-delay: 0.3s">
                <div class="auction-image-container">
                    ...
                    <?php else: ?>
                        <div class="no-image">
                            <i class="fas fa-car" style="font-size: 40px; color: #999;"></i>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="auction-details">
                    ...
                    <div class="auction-meta">
                        <span><i class="fas fa-tag"></i> <?= htmlspecialchars($auction['category']) ?></span>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        pathArray.forEach((segment, index) => {
            ...
            if (index === pathArray.length - 1) {
                li.innerHTML = `<i class="fas fa-car"></i> ${document.title || label}`;
            } else {
