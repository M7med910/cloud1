...
$stmt = $pdo->prepare("
    ...
    WHERE p.category = 'عقار'   
    LIMIT 10  -- لتقليل عدد النتائج
");
$stmt->execute();
$auctions = $stmt->fetchAll(PDO::FETCH_ASSOC);

$stmt = $pdo->prepare("SELECT * FROM product WHERE category = 'عقار'");
$stmt->execute();
...
<head>
    ...
    <title>مزاد العقارات | منصة المزادات</title>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="منصة المزادات الرائدة لبيع وشراء العقارات بسهولة وأمان. سجل الآن وابدأ المزايدة!">
    <meta property="og:title" content="مزاد العقارات | منصة المزادات">
    <meta property="og:description" content="المنصة الأفضل لمزادات العقارات في الوطن العربي">
...
<header class="main-header">
    <div class="header-container">
        ...
        <div class="search-container">
            <input type="text" class="search-input" placeholder="ابحث عن مزادات العقارات...">
        </div>
    </div>
</header>
...
<section id="auctions" class="section animate-fade" style="animation-delay: 0.2s">
    <h2 class="section-title">مزادات العقارات</h2>
            ...
            <div class="auction-card animate-fade" style="animation-delay: 0.3s">
                ...
                <div class="auction-details">
                    ...
                    <div class="auction-meta">
                        <span><i class="fas fa-building"></i> <?= htmlspecialchars($auction['category']) ?></span>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        pathArray.forEach((segment, index) => {
            ...
            if (index === pathArray.length - 1) {
                li.innerHTML = `<i class="fas fa-home"></i> ${document.title || label}`;
            } else {
